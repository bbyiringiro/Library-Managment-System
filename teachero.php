	...
	$.ajax({
		...
		success: function(data){
			...
			$(results).each(function(key, value) {
				...
				$('#suggest').append('<li class="item" onClick="direct3('+value.pro_id+')"><a href="check_stud.php?id='+value.pro_id+'"><span class="name">' + value.name.toUpperCase()+ '</span><span class="right">'+value.title+'</span></a></li>');
...
if (event.type == 'mouseover') {
 ...
 $(document).keypress(function(evt){
      ...
      <script src="js/main.js"></script> <!-- Resource jQuery --><h2><a href="index.php" id="link" style="color:#37a69b;"><i  class="mdi-hardware-keyboard-backspace"></i></a></h2>
    </body>
  </html>
